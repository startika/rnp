...
describe PodcastsController do
  ...
  describe "handling POST /podcasts with valid data" do
  ...
  describe "handling POST /podcasts with invalid data" do
  ...
  describe "handling PUT /podcasts/:id with valid data" do
  ...
  describe "handling PUT /podcasts/:id with invalid data" do
